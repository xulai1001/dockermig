...
runc_base = "/home/islab/src/dockermig/containers/"
...
def real_dump(precopy, postcopy):
    ...
    os.chdir(base_path)
    print base_path
    cmd = 'runc checkpoint --image-path bundle --leave-running'
    cmd = 'runc checkpoint --image-path bundle '
    if precopy:
